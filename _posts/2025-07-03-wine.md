...
---
Yesterday our family took our very first [Pepsi Challenge](https://en.wikipedia.org/wiki/Pepsi_Challenge)—which happens to be 50 years old this year. And, sorry to brag here, but I confidently identified the Pepsi-Cola in all of its glorious superiority to Coca-Cola.
...
<p><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Smelling_the_wine.jpg/960px-Smelling_the_wine.jpg" width="20%"><span class="muted small">Me detecting notes of petrichor at your next dinner party.</span></p>

There is an inflection point, though, because it's true that the "Two Buck Chuck" is really and truly swill, and you know it once you first smell it. But as you go up the wine price curve, those interesting aforementioned research insights kick in and there are clearly (heavily) diminishing returns. A college girlfriend's father once shared his wisdom: pick a price range that works for your wallet, and figure out what suits you (which varietals, which regions, which brands). I guess you can do that with any purchase: get to know and optimize within a price band. Ergo, the Trader Joe's boxed Chardonnay in our fridge! And then, truth be told, when we do have a "nicer" bottle of something—or a varietal we don't often drink—I find myself remarking heartily what an enjoyable quaff it is.
