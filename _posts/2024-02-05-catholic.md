...
And I should say: the Faith has become more real to me since then in ways I struggle to articulate. There have been moments in prayer (sometimes just lying in bed in the dark) where something breaks through that I can only attribute to the Holy Spirit. No dramatic visions or anything, but little epiphanies that I can understand to be extrinsic. Again, I wouldn't say I'm special, and so that makes me conclude (and gently suggest) that it's available to you, too—and that the Church exists precisely to make encounter with Christ possible.

## Still Being Written

This blog post is fated to remain in `draft` status because my faith life is evolving and ever-changing. Each stage has been its own kind of grace, from the childhood absorption to young adulthood questioning to late-twentysomething meandering to the husband and father who is being shaped into a new creation (however slowly and painstakingly).

But I'm convinced that not a shred of it is wasted...for the Hound of Heaven doesn't give up the chase.
