...
Which means I used...
- [Path](https://en.wikipedia.org/wiki/Path_(social_network)) for social media,
- [Songza](https://en.wikipedia.org/wiki/Songza) for music, and
- **Foursquare—now [Swarm](https://swarmapp.com/)—**for lifelogging.
