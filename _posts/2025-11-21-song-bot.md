...
I've fastidiously curated this song catalog over the past year, and it's been revealing about my tastes: skewing classic rock and folk-rock from the '60s-'80s golden era, with generous helpings of singer-songwriters, soul/R&B, and live tracks. And I guess I do love Christmas (as [previously discussed](/xmas-music)), because the yuletide carols (both sacred and secular) *wrap* the year (early December to early January). I went for diversity of artist (i.e., no artist has more than six tracks), and I've got a proclivity toward deep tracks, so if it's a hit, it made the list because it's just golden. But hey, *De gustibus non est disputandum,* as Grandpa was wont to say.
...
<p><img src="/assets/og/post_telegram-workflow.png" alt="Failing Telegram workflows" style="width: 50%;"><span class="muted small">Fail, fail, fail, success, fail, fail...</span></p>
...
3. **GitHub Actions Workflows**
  ...
  - **Workflow #2: Daily Song Sender** (`telegram-daily-song.yml`) – Runs a half hour later (~07:45), reading today's song from YAML, sending to all subscribers in the JSON file (e.g., #324: "Can I Believe You" by Fleet Foxes [with clickable link to the track on YouTube Music])
...
Feel free to <a href="https://t.me/pb_song_bot" target="_blank">test it out</a> and then if our musical tastes aren't matching up, just slip out with an `/unsubscribe`. And if you're motivated, you could make your own by cloning these workflows and `.yml` files from [my GitHub repo](https://github.com/berensp/berensp.github.io/).
