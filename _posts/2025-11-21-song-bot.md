...
## Options
1. <a href="https://t.me/pb_song_bot" target="_blank">Try it out</a> and then if you're not feelin' my jams, just sneak out with an `/unsubscribe`
2. If you're more of *pull* person than a *push* person, you can get the song of the day via the [today](/today/) page, as I mentioned.
3. If you're extra jazzed about bots and motivated, you could make your own by cloning these workflows and `.yml` files from [my GitHub repo](https://github.com/berensp/berensp.github.io/).
