...
What's interesting is that certain disease categories pop up as you'd expected (e.g., **circulatory**), but you also see certain social determinants of health[^2] with, for example, injuries — i.e., **drug overdose**, **firearm-related deaths**, **motor vehicle accidents** — accounting for 43% of American men's life expectancy gap[^3].
