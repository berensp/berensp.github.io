...
<span class="muted small">Introducing...Dark Mode on berens.co [rampageous applause]</span>

## Clarification

Hold up. *(Screeching brakes.)*

I have to confess that this post isn't so much about how fantastically awesome it is to have system preference-aware dark mode on my website as about *how I achieved* dark mode in the first place.
...
Then I tried **Claude Code** and old-school vibe coding instantly became dial-up internet.

## Setting Up Claude Code

Claude Code is a command-line tool that connects directly to your GitHub repository. I pointed it at the repo for berens.co, and suddenly Claude wasn't just advising me—it was working directly in my codebase.

## The Dark Mode Case Study

I needed a project to test drive this: how about building dark mode, everyone's favorite UI enhancement. In the old vibe coding workflow, this would have meant dozens of copy-paste cycles across multiple files—CSS variables, media queries, template updates, testing each piece.

Instead, I opened Claude Code and typed: *"what's the simplest way to implement a 'dark mode' on my current setup; one that inherits the 'system preference' of the browser?"*
