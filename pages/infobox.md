...
<p><table>
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: left"><code><a href="/races/">{{ site.data.races.races | size }}</a></code></td>
    </tr>
    <tr>
    ...
    <tr>
      <th colspan="2" style="text-align: center; background-color: var(--table-section-header-bg);">Style<sup id="fnref5"><a href="#fn5" title="View footnote">5</a></sup></th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: left"><code>@berensp</code></td>
    </tr>
    <tr>
      <td style="text-align: left">Beer order</td>
      <td style="text-align: left"><code>amber lager</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: left"><code>en</code>, <code><a href="/spanish.html">es</a></code>, <code>ko</code><sup id="fnref6"><a href="#fn6" title="View footnote">6</a></sup></td>
    </tr>
    <tr>
...
<ol id="footnotes">
  ...
  <li id="fn5">Style as in "intentional constraints" as <a href="https://stephango.com/style" target="_blank">articulated by Steph Ango</a>. More <a href="/style/">here</a>.<a href="#fnref5" title="Return to article">↩</a></li>
