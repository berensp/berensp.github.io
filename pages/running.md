...
Hey, I might rather be [cycling](/cycling/), but when time is dear there aren't many aerobic options as easy and endorphin-boosting as running. Given the choice I opt for the trail; not just to be good to these patellofemoral arthralgia-disposed knees, but also to be able to take in some beautiful scenery whilst catching up on podcasts or [just thinking](/solvitur-currendo.html).
