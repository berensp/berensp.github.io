...
permalink: /apologia/
---
I have a separate post called ["Why I Am A Catholic"](/catholic.html), which is more my faith journey, but the reasons and evidence here undergird that faith.

This *apologia* exists mostly for my own reference: theology and apologetics endlessly fascinate me, and I wanted a running tally of the most common—and most interesting—arguments and counterarguments for:
...
- **Argument from Contingency (Leibniz/Aquinas' Third Way)**. Everything in the universe is contingent—it could have failed to exist, and depends on something else for its existence. But an infinite regress of contingent things explains nothing; you can't account for why anything exists by pointing to another thing that itself needs explaining. There must be a necessary being to ground the whole chain (i.e., one that exists by its own nature, not dependent on anything else). Leibniz said the fundamental question is "why is there something rather than nothing?" and contingent beings, by definition, can never be the final answer to that question.
...
- **Argument from Reason.** (Reason from non-reason [Reliable Cognition].) If our cognitive faculties are the product of undirected evolutionary processes aimed only at survival (not truth), we have no reason to trust them when they venture beyond immediate survival needs into abstract reasoning about reality.

[^1]: The odds of the universe coming into existence in a way that would develop and support life (i.e. of our universe's exceedingly low entropy [high order]) were calculated to be 1 / (10^10^123).
...
- **The longevity of the Church.** The idea that the Church, run by broken, sinful, misguided humans has outlasted the Roman Empire by one and a half millennia is incredible. It should've been run aground long ago. It's almost as if it's being guided by an invisible hand. Hilaire Belloc makes this point persuasively:
...
- **Biblical/Textual Arguments Against Petrine Primacy.** The Catholic case for the papacy leans heavily on Matthew 16:18 ("You are Peter, and on this rock I will build my church"), but critics argue the text doesn't bear that weight: (1) in Greek, *Petros* (Peter, a stone) and *petra* (bedrock) are technically different words, leaving room to argue Christ built on Peter's *confession* rather than Peter himself; (2) elsewhere the apostles *collectively* are called the Church's foundation (Eph 2:20, Rev 21:14), and Paul rebukes Peter publicly in Galatians 2:11-14—hard to square with a supreme, binding teaching office; (3) the NT never shows Peter exercising singular jurisdiction over the other apostles—James, not Peter, appears to preside at the Council of Jerusalem (Acts 15); (4) no verse states Peter's authority, whatever its scope, was meant to transfer to future bishops of Rome specifically.
	- ***Sed contra:*** The *Petros/petra* distinction is a Greek translation artifact—Jesus almost certainly spoke Aramaic, where *Kepha* covers both "Peter" and "rock" with no distinction, which is why the Aramaic Peshitta and the Church Fathers read Peter himself as the rock. Scripture holds both truths at once: Peter alone receives the keys (Mt 16:19, echoing Isaiah 22:22's steward office), while the apostles as a body are elsewhere called foundational too—the offices aren't exclusive, and Peter is consistently listed and addressed first. At Jerusalem, presiding is a matter of hosting, not doctrinal supremacy—it's Peter's speech (Acts 15:7-11) that settles the theological question before James ratifies it. And succession isn't spelled out biblically any more than the canon itself is—both rest on apostolic Tradition, which rapidly and uniformly recognized Rome's bishop (not Antioch's, not Jerusalem's) as authoritative: Clement of Rome intervening in Corinth's affairs (c. 96 AD) and Irenaeus naming Roman succession as the standard for orthodoxy by 180 AD.
- **Doctrinal Innovations / Biblical Contradictions** Many Catholic doctrines (purgatory, Marian dogmas, papal infallibility) developed centuries after the apostolic period with debatable biblical support. Similarly, practices like priestly celibacy, prohibition of female clergy, and prayer to saints appear to contradict certain biblical passages.
	- ***Sed contra:*** There actually is biblical support for all of these; even if each one isn't explicitly mentioned in scripture. And that's precisely why there is a (one) church, guided by the H.S.; and not leaving interpretation to each one (yielding ~30k Protestant churches).
- **Historical Hypocrisy** - The Inquisition, Crusades, corruption scandals, and clergy abuse crises undermine claims of divine guidance and moral authority. I.e., if Christianity is true, it should make its adherents good, and the world should be able to recognize the Faith's truth by its adherents' good works. And yet, to quote Fr. Lupe from my friend Fr. Jeremy's article[^8], "I've had a deep conviction that most middle-class Catholics are phony Christians, just as materialistic and self-seeking, and as liable to go along with others, as any non-Christian, and often more so." So true.
