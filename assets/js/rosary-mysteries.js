...
function updateRosaryInfo() {
  ...
  document.getElementById('todayInfo').innerHTML = `📿 Today is the <mark>${todayMystery.set} Mysteries</mark> since it's currently ${todayMystery.day} ${formattedTime} in San Francisco.`;
